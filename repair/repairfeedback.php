...
<body>
  ...
  <section class="page-section">
    <div class="container">
      ...
      <div class="card">
      <?php
          $Postagelabel = htmlspecialchars($_GET["Postage_label"]);
          $Descriptiondamages = htmlspecialchars($_GET["Description_damages"]);
          $upper = htmlspecialchars($_GET["acolour"]);
          $laces = htmlspecialchars($_GET["bcolour"]);
          $sole = htmlspecialchars($_GET["ccolour"]);
          $base = htmlspecialchars($_GET["dcolour"]);
          $Address = htmlspecialchars($_GET["Shipping_address"]);

          echo "Postage Label: " . $Postagelabel. "<br />";
          echo "Description of what is damaged: " . $Descriptiondamages. "<br />";
          echo "Colour of upper: " . $upper. "<br />";
          echo "Colour of laces: " . $laces. "<br />";
          echo "Colour of sole: " . $sole. "<br />";
          echo "Colour of base: " . $base. "<br />";
          echo "Ship back to following address: " . $Address. "<br />";
      ...
      <h2>
        <ul style="list-style: none;">
          <li> THANK YOU!! </li>
          <li> FOR YOUR SUBMISSION </li>
          <li> WE WILL REPAIR AND RETURN IT ASAP </li>
        </ul>
      </h2>
    </div>
  </section>
